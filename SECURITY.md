...
We take security vulnerabilities seriously. If you discover a security issue in FluxFlow ComfyUI, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to https://github.com/danny-mio/fluxflow-comfyui/security/advisories
   - Click "Report a vulnerability"
   - Provide detailed information about the vulnerability

2. **Email**
   - Send to: danny-mio@libero.it
   - Subject: "[SECURITY] FluxFlow ComfyUI - [Brief Description]"
...
- **General questions**: https://github.com/danny-mio/fluxflow-comfyui/discussions
- **Bug reports**: https://github.com/danny-mio/fluxflow-comfyui/issues
